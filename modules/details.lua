...
mod.info = "Details profile and dynamic meter showing/hiding."
mod.depends = { "Details" }
...
local options = {
    ...
    args = {
        ...
        profile_import_string = {
            ...
            get = function(_) return mod.profile_import_string end,
        },
        skin_import_string = {
            ...
            multiline = 5,
            set = function(info) info.option.get() end,
            get = function(_) return mod.skin_import_string end,
        },
    },
}
